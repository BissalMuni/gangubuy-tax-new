...
status: "draft"
law_reference: "지방세법 §11, §13, §13의2, §13의3, §15"
tags: ["주택", "취득세", "세율", "유상거래", "상속", "증여", "원시취득", "다주택", "법인", "고급주택"]
---

# 주택 취득세율

> 주택 취득 시 취득유형(유상거래, 상속, 증여, 원시취득)과 주택 수, 취득자 유형(개인, 법인)에 따른 세율을 안내한다.
...
<LawReferenceTable refs={[
  { kind: '근거법', lawName: '지방세법', articleText: '§11①8', note: '주택 유상거래 세율',
    link: { law: '지방세법', article: '제11조' } },
  { kind: '경과규정', lawName: '부칙', articleText: '제5조', note: '1세대4주택 경과규정' },
]} />
...
<LawReferenceTable refs={[
  { kind: '근거법', lawName: '지방세법', articleText: '§15①(세율특례)', note: '1가구1주택 감면',
    link: { law: '지방세법', article: '제15조' } },
  { kind: '근거법', lawName: '지방세법', articleText: '§11①1나', note: '상속 일반세율 2.8%',
    link: { law: '지방세법', article: '제11조' } },
  { kind: '시행령', lawName: '지방세법 시행령', articleText: '§29③', note: '취득세 상속순위',
    link: { law: '지방세법시행령', article: '제29조' } },
  { kind: '관련법', lawName: '민법', articleText: '§1000~1001', note: '상속순위, 대습상속',
    link: { law: '민법', article: '제1000조' } },
  { kind: '관련법', lawName: '민법', articleText: '§27~28', note: '실종선고' },
  { kind: '관련법', lawName: '농특세법', articleText: '§4(비과세) 10의4', note: '1가구1주택 농특세 비과세' },
]} />
...
<LawReferenceTable refs={[
  { kind: '근거법', lawName: '지방세법', articleText: '§11①2', note: '증여 일반세율 3.5%',
    link: { law: '지방세법', article: '제11조' } },
  { kind: '중과', lawName: '지방세법', articleText: '§13의2②', note: '조정지역 3억↑ 증여 중과 12%',
    link: { law: '지방세법', article: '제13조의2' } },
  { kind: '증여의제', lawName: '지방세법', articleText: '§7⑪', note: '배우자·직계존비속 간',
    link: { law: '지방세법', article: '제7조' } },
  { kind: '주택수', lawName: '지방세법', articleText: '§13의3', note: '주택 수 판단',
    link: { law: '지방세법', article: '제13조의3' } },
  { kind: '과세표준', lawName: '지방세법', articleText: '§10의2', note: '시가인정액',
    link: { law: '지방세법', article: '제10조의2' } },
  { kind: '합의해제', lawName: '시행령', articleText: '§20', note: '계약해제 요건',
    link: { law: '지방세법시행령', article: '제20조' } },
  { kind: '특수관계인', lawName: '소득세법', articleText: '§101①', note: '특수관계인 범위' },
]} />
...
<LawReferenceTable refs={[
  { kind: '근거법', lawName: '지방세법', articleText: '§11①3', note: '원시취득 세율 2.8%',
    link: { law: '지방세법', article: '제11조' } },
]} />
...
<LawReferenceTable refs={[
  { kind: '근거법', lawName: '지방세법', articleText: '§13의2', note: '다주택 중과세율',
    link: { law: '지방세법', article: '제13조의2' } },
  { kind: '근거법', lawName: '지방세법', articleText: '§13의2①', note: '1세대 4주택 중과',
    link: { law: '지방세법', article: '제13조의2' } },
  { kind: '근거법', lawName: '지방세법', articleText: '§13의3', note: '분양권·입주권 포함',
    link: { law: '지방세법', article: '제13조의3' } },
  { kind: '시행령', lawName: '지방세법 시행령', articleText: '§28의2', note: '조정대상지역 기준',
    link: { law: '지방세법시행령', article: '제28조의2' } },
  { kind: '관련법', lawName: '지방세법', articleText: '§11', note: '일반 취득세율',
    link: { law: '지방세법', article: '제11조' } },
]} />
...
<LawReferenceTable refs={[
  { kind: '근거법', lawName: '지방세법', articleText: '§13의2①3', note: '법인 주택 중과',
    link: { law: '지방세법', article: '제13조의2' } },
  { kind: '근거법', lawName: '지방세법', articleText: '§10', note: '과세표준 산정',
    link: { law: '지방세법', article: '제10조' } },
  { kind: '근거법', lawName: '지방세법', articleText: '§11', note: '일반 취득세율',
    link: { law: '지방세법', article: '제11조' } },
  { kind: '시행령', lawName: '지방세법 시행령', articleText: '§28', note: '취득가액 산정 기준',
    link: { law: '지방세법시행령', article: '제28조' } },
  { kind: '관련법', lawName: '지방세법', articleText: '§13의2', note: '다주택 중과 전체',
    link: { law: '지방세법', article: '제13조의2' } },
]} />
...
<LawReferenceTable refs={[
  { kind: '근거법', lawName: '지방세법', articleText: '§13⑤1', note: '사치성재산 중과',
    link: { law: '지방세법', article: '제13조' } },
  { kind: '시행령', lawName: '지방세법 시행령', articleText: '§28①', note: '고급주택 판정 기준',
    link: { law: '지방세법시행령', article: '제28조' } },
  { kind: '관련법', lawName: '지방세법', articleText: '§11', note: '일반 취득세율',
    link: { law: '지방세법', article: '제11조' } },
  { kind: '관련법', lawName: '지방세법', articleText: '§15', note: '중과기준세율',
    link: { law: '지방세법', article: '제15조' } },
  { kind: '관련법', lawName: '지방세특례제한법', articleText: '-', note: '상속 감면 시 고급주택 제외' },
]} />
