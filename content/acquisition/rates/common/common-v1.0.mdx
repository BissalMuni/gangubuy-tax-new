...
<LawReferenceTable refs={[
  { kind: '세율특례', lawName: '지방세법', articleText: '§11①5', note: '공유물분할 세율',
    link: { law: '지방세법', article: '제11조' } },
  { kind: '과세표준', lawName: '지방세법', articleText: '§15①4', note: '분할취득 과세표준',
    link: { law: '지방세법', article: '제15조' } },
  { kind: '시행령', lawName: '지방세법 시행령', articleText: '§29조의2', note: '공유물분할 세부 기준',
    link: { law: '지방세법시행령', article: '제29조의2' } },
  { kind: '판례', lawName: '대법원', articleText: '2020두53972', note: '교환가치 비율 인정' },
]} />
...
<LawReferenceTable refs={[
  { kind: '법인 본점 중과', lawName: '지방세법', articleText: '§13①', note: '대도시 법인 본점 설치',
    link: { law: '지방세법', article: '제13조' } },
  { kind: '공장 중과', lawName: '지방세법', articleText: '§13②', note: '대도시 공장 신·증설',
    link: { law: '지방세법', article: '제13조' } },
  { kind: '대도시 범위', lawName: '수도권정비계획법', articleText: '시행령 별표', note: '과밀억제권역 지정' },
  { kind: '중과기준세율', lawName: '지방세법', articleText: '§13', note: '2%',
    link: { law: '지방세법', article: '제13조' } },
]} />
...
<LawReferenceTable refs={[
  { kind: '사치성재산 중과', lawName: '지방세법', articleText: '§13⑤', note: '중과세율 규정',
    link: { law: '지방세법', article: '제13조' } },
  { kind: '고급주택 기준', lawName: '지방세법 시행령', articleText: '§28', note: '고급주택 세부 기준',
    link: { law: '지방세법시행령', article: '제28조' } },
  { kind: '중과기준세율', lawName: '지방세법', articleText: '§13', note: '2%',
    link: { law: '지방세법', article: '제13조' } },
  { kind: '골프장', lawName: '체육시설법', articleText: '-', note: '회원제 골프장 정의' },
]} />
...
<LawReferenceTable refs={[
  { kind: '부담부증여', lawName: '지방세법', articleText: '§7⑫', note: '채무액·증여 구분 과세',
    link: { law: '지방세법', article: '제7조' } },
  { kind: '과세표준 일반', lawName: '지방세법', articleText: '§10', note: '유상·무상 구분',
    link: { law: '지방세법', article: '제10조' } },
  { kind: '시가인정액', lawName: '지방세법', articleText: '§10의2', note: '평가기간·적용순서',
    link: { law: '지방세법', article: '제10조의2' } },
  { kind: '유사부동산', lawName: '지방세법', articleText: '§10의3', note: '유사부동산 범위',
    link: { law: '지방세법', article: '제10조의3' } },
  { kind: '시가표준액', lawName: '지방세법', articleText: '§10의4', note: '시가인정액 없는 경우',
    link: { law: '지방세법', article: '제10조의4' } },
]} />
...
<LawReferenceTable refs={[
  { kind: '면세점', lawName: '지방세법', articleText: '§16', note: '취득가액 50만원 이하',
    link: { law: '지방세법', article: '제16조' } },
  { kind: '공동주택 개수', lawName: '지방세법', articleText: '§9①⑥', note: '9억원 이하 주택 개수 비과세',
    link: { law: '지방세법', article: '제9조' } },
  { kind: '대수선 정의', lawName: '건축법', articleText: '§2①9', note: '대수선 범위' },
]} />
...
<LawReferenceTable refs={[
  { kind: '주택 수 산정', lawName: '지방세법', articleText: '§13의3', note: '분양권·입주권·오피스텔 포함',
    link: { law: '지방세법', article: '제13조의3' } },
  { kind: '다주택 중과', lawName: '지방세법', articleText: '§13의2', note: '중과세율 규정',
    link: { law: '지방세법', article: '제13조의2' } },
  { kind: '1세대 범위', lawName: '지방세법 시행령', articleText: '-', note: '배우자·미혼30세미만 직계비속' },
  { kind: '상속주택 특례', lawName: '지방세법 시행령', articleText: '-', note: '5년간 주택 수 제외' },
  { kind: '준주택', lawName: '주택법', articleText: '§2', note: '준주택 범위',
    link: { law: '주택법', article: '제2조' } },
]} />
