...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: 'var(--content-font-size, 13px)', marginBottom: '16px'}}>
  ...
  <tbody>
    <tr>
      ...
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}><LawLink law="지방세법" article="제10조">§10</LawLink>~<LawLink law="지방세법" article="제10조의6">§10의6</LawLink></td>
    ...
    <tr>
      ...
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}><LawLink law="지방세법시행령" article="제14조">§14</LawLink></td>
