...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: 'var(--content-font-size, 13px)', marginBottom: '16px'}}>
  ...
  <tbody>
    <tr style={{backgroundColor: '#e6f7ff'}}>
      ...
      <td style={{border: '1px solid #d9d9d9', padding: '10px'}}><strong style={{color: '#cf1322'}}>"철거" 시점</strong><br/>철거 전까지는 '주택'으로 봄 (입주권이 아닌 주택 보유로 판단)</td>
    </tr>
    <tr style={{backgroundColor: '#e6f7ff'}}>
...
- **입주권 원조합원**: 관리처분인가 후 기존 주택이 철거되는 시점에 '입주권'을 취득한 것으로 봄. 철거 전까지는 기존 주택 보유 상태
