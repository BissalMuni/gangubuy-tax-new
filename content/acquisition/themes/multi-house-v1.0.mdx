...
<SectionNav sections={[
  { id: "중과세율", label: "중과세율" },
  { id: "주택수산정", label: "주택수 산정" },
  { id: "1세대1주택", label: "1세대1주택" },
  { id: "일시적2주택", label: "일시적 2주택" },
  { id: "중과제외주택", label: "중과제외 주택" },
  { id: "오피스텔", label: "오피스텔" },
...
2. 이혼재산분할 (법 §15①6호, 민법 §834·839의2·840)
...
<Outline level={2}>법인 주택 취득 (§13의2①1호)</Outline>
- 법인(국세기본법 §13에 따른 법인으로 보는 단체, 법인 아닌 사단·재단 포함)이 주택을 취득하는 경우
...
<Outline level={2}>중과대상 주택의 범위 (§13의2①)</Outline>

- **주택**: 법 §11①8호에 따른 주택
- 주택의 **공유지분**이나 **부속토지**만 취득해도 주택 소유로 봄

<Outline level={2}>고급주택 복합 중과 (§13의2③)</Outline>

다주택 중과(§13의2①/②)와 고급주택(§13⑤)이 **동시에 적용**되는 경우

**추가 세율**: 중과기준세율×400% (4%) 추가
...
<h2 id="주택수산정">
  <Outline level={1}>주택수 산정 (시행령 §28조의4)</Outline>
</h2>

<Outline level={2}>산정범위</Outline>
...
<Outline level={2}>특수 케이스</Outline>
...
<Outline level={2}>소형주택 주택수 제외 (2024.3.26 시행, 소급 2024.1.10~)</Outline>
...
<h2 id="1세대1주택">
  <Outline level={1}>1세대1주택 판단범위 (§111조의2, 시행령 §110조의2, §28의3)</Outline>
</h2>
...
<Outline level={2}>가족의 범위 (민법 §779조)</Outline>

- 배우자, 직계혈족 및 형제자매 → 생계를 달리해도 가족
- 직계혈족의 배우자, 배우자의 직계혈족 및 형제자매 → **생계를 같이해야** 가족에 포함 (인척)

<Outline level={2}>중위소득 기준 (보건복지부 고시 2025-135호, 2025.8.1 기준)</Outline>
...
<h2 id="일시적2주택">
  <Outline level={1}>일시적 2주택 (시행령 §28의5)</Outline>
</h2>
...
<h2 id="중과제외주택">
  <Outline level={1}>중과제외 주택 (시행령 §28조의2, 12종류)</Outline>
</h2>

<Outline level={2}>주택수 합산배제 대상</Outline>
...
<Outline level={2}>5년이내 상속주택</Outline>

- 5년 초과 시 주택수 포함
- 공동 상속 시 상속지분이 가장 큰 상속인의 소유주택으로 판단
  - 지분 동일 시 "당해 주택 거주자" → "최연장자" 순

<Outline level={2}>저가주택 유의사항</Outline>
...
<Outline level={2}>멸실목적 취득</Outline>
...
<h2 id="경과조치">
  <Outline level={1}>경과조치 및 적용례 (부칙 §6, §7)</Outline>
</h2>
