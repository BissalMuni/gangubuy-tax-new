...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: 'var(--content-font-size, 13px)', marginBottom: '16px'}}>
  ...
  <tbody>
    <tr style={{backgroundColor: '#fafafa'}}>
      <td colSpan={3} style={{border: '1px solid #d9d9d9', padding: '8px', fontWeight: 'bold'}}>300만원 감면 대상 (<LawLink law="지방세특례제한법" article="제36조의3">§36의3①1호</LawLink>)</td>
    </tr>
    <tr>
    ...
    <tr style={{backgroundColor: '#fafafa'}}>
      <td colSpan={3} style={{border: '1px solid #d9d9d9', padding: '8px', fontWeight: 'bold'}}>200만원 감면 대상 (<LawLink law="지방세특례제한법" article="제36조의3">§36의3①2호</LawLink>)</td>
    </tr>
    <tr>
...
- 공동취득 시 총 감면액 한도 300만원/200만원 (<LawLink law="지방세특례제한법" article="제36조의3">§36의3②</LawLink>)
- 중과규정(<LawLink law="지방세법" article="제13조의2">법 §13의2</LawLink>) 세율 **적용하지 않음**
...
- 단독주택, 아파트, 다세대, 연립 등 공동주택 (<LawLink law="주택법" article="제2조">주택법 §2①</LawLink>)
- **제외**: 오피스텔, 분양권
...
<h2 id="추징요건">
  <Outline level={1}>추징요건 (<LawLink law="지방세특례제한법" article="제36조의3">§36의3④</LawLink>)</Outline>
</h2>
...
- 세부 기준은 행정안전부장관 고시 참조 (<LawLink law="지방세특례제한법" article="제36조의3">§36의3⑤</LawLink>)
...
<h2 id="예외조항">
  <Outline level={1}>예외조항 — 주택 소유 사실이 없는 것으로 보는 경우 (<LawLink law="지방세특례제한법" article="제36조의3">§36의3③</LawLink>)</Outline>
</h2>
...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: 'var(--content-font-size, 13px)', marginBottom: '16px'}}>
  ...
  <tbody>
    <tr>
      ...
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}><LawLink law="지방세특례제한법" article="제36조의3">§36의3</LawLink></td>
    ...
    <tr>
      ...
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}><LawLink law="지방세법" article="제11조">§11①8호</LawLink></td>
    ...
    <tr>
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}>참조</td>
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}>지방세법</td>
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}><LawLink law="지방세법" article="제10조의3">§10의3</LawLink></td>
