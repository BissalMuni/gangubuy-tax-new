...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: 'var(--content-font-size, 13px)', marginBottom: '16px'}}>
  ...
  <tbody>
    <tr>
      ...
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}><LawLink law="지방세특례제한법" article="제31조">§31</LawLink></td>
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}>공공임대주택</td>
    </tr>
    <tr>
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}>근거법</td>
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}>지방세특례제한법</td>
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}><LawLink law="지방세특례제한법" article="제31조의3">§31의3</LawLink></td>
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}>장기일반민간임대주택</td>
    </tr>
    <tr>
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}>추징</td>
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}>지방세특례제한법</td>
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}><LawLink law="지방세특례제한법" article="제178조">§178②</LawLink></td>
