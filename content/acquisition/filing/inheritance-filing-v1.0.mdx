...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: 'var(--content-font-size, 13px)', marginBottom: '16px'}}>
  ...
  <tbody>
    <tr>
      ...
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}><LawLink law="지방세법" article="제15조">§15</LawLink></td>
    ...
    <tr>
      ...
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}><LawLink law="지방세법시행령" article="제29조">§29</LawLink></td>
    ...
    <tr>
      ...
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}><LawLink law="민법" article="제1000조">§1000</LawLink>, <LawLink law="민법" article="제1001조">§1001</LawLink></td>
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}>상속순위, 대습상속</td>
    </tr>
    <tr>
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}>참조</td>
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}>민법</td>
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}><LawLink law="민법" article="제779조">§779</LawLink></td>
