...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: 'var(--content-font-size, 13px)', marginBottom: '16px'}}>
  ...
  <tbody>
    <tr>
      ...
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}><LawLink law="신탁법" article="제59조">신탁법 §59</LawLink></td>
    </tr>
    <tr>
...
<table style={{width: '100%', borderCollapse: 'collapse', fontSize: 'var(--content-font-size, 13px)', marginBottom: '16px'}}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={{border: '1px solid #d9d9d9', padding: '8px'}}><LawLink law="신탁법" article="제59조">§59</LawLink></td>
