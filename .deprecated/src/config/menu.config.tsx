...
export const sidebarThemeMenuItems: MenuItem[] = [
  {
    ...
    children: [
      ...
      {
        key: ROUTES.LOCAL_TAX_THEME.ACQUISITION.HOUSEHOLD_STANDARD,
        icon: <UsergroupDeleteOutlined />,
        label: <Link to={ROUTES.LOCAL_TAX_THEME.ACQUISITION.HOUSEHOLD_STANDARD}>1세대의 기준</Link>,
      },
      {
        key: ROUTES.LOCAL_TAX_THEME.ACQUISITION.HOUSE_STANDARD,
        icon: <CalculatorOutlined />,
        label: <Link to={ROUTES.LOCAL_TAX_THEME.ACQUISITION.HOUSE_STANDARD}>1주택 기준</Link>,
      },
    ],
  },
  {
