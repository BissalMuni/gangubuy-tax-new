...
export default function Content05SupremeCourtV10() {
  return (
    <div className="space-y-6">
      ...
      <h1 className="text-2xl font-bold mb-4">대법원 판례</h1>
      ...
      <ul className="list-disc pl-6 my-4 space-y-1">
        ...
        <li><strong>대도시</strong> — 지방세법상 등록세·취득세 중과세가 적용되는 도시로, 대도시 내 법인 설립·지점 설치·전입 및 그 이후 5년 내 부동산 취득에 중과세가 부과되는 지역적 개념.</li>
        <li>관련 조문: <a href="https://law.go.kr/법령/지방세법/제138조" target="_blank" rel="noopener noreferrer">법 §138 제1항 제3호</a>, <a href="https://law.go.kr/법령/지방세법/제13조" target="_blank" rel="noopener noreferrer">법 §13 제2항 제1호</a></li>
        <li><strong>본점 신증축 중과</strong> — 과밀억제권역 안에서 본점 또는 주사무소용 건축물을 신축 또는 증축하여 취득하는 경우에 적용되는 취득세 중과세 제도.</li>
        <li>관련 조문: <a href="https://law.go.kr/법령/지방세법/제112조" target="_blank" rel="noopener noreferrer">법 §112 제3항</a>, <a href="https://law.go.kr/법령/지방세법/제13조" target="_blank" rel="noopener noreferrer">법 §13 제2항 제1호</a></li>
        <li><strong>지점·분사무소</strong> — 법인세법·부가가치세법 또는 소득세법에 의해 등록된 사업장으로서 인적·물적 설비를 갖추고 계속하여 당해 법인의 사무 또는 사업이 행하여지는 장소이며, 고용형식은 직속 형태일 필요가 없다.</li>
        <li>관련 조문: <a href="https://law.go.kr/법령/지방세법/제138조" target="_blank" rel="noopener noreferrer">법 §138 제1항 제3호</a>, <a href="https://law.go.kr/법령/지방세법시행령/제102조" target="_blank" rel="noopener noreferrer">시행령 §102 제2항</a>, <a href="https://law.go.kr/법령/지방세법시행규칙/제55조의2" target="_blank" rel="noopener noreferrer">시행규칙 §55의2</a></li>
        <li><strong>5년 이내 부동산 취득 중과</strong> — 법인의 대도시 내 설립·설치·전입 이후 5년 이내에 취득하는 업무용·비업무용·사업용·비사업용을 불문한 일체의 부동산에 대해 취득세(등록세)를 중과하는 규정.</li>
        <li>관련 조문: <a href="https://law.go.kr/법령/지방세법/제138조" target="_blank" rel="noopener noreferrer">법 §138 제1항 제3호</a>, <a href="https://law.go.kr/법령/지방세법시행령/제102조" target="_blank" rel="noopener noreferrer">시행령 §102 제2항</a>, <a href="https://law.go.kr/법령/지방세법/제13조" target="_blank" rel="noopener noreferrer">법 §13 제2항 제1호</a>, <a href="https://law.go.kr/법령/지방세법시행령/제27조" target="_blank" rel="noopener noreferrer">시행령 §27 제3항</a></li>
        <li><strong>등록세 중과 추징 기산일</strong> — 주상복합 신축 시 판매시설 면적이 착공 시 확정되는 경우 등록세 중과 추징 사유 발생일은 착공일이며, 착공일로부터 30일 이내에 신고·납부하여야 한다.</li>
        <li>관련 조문: <a href="https://law.go.kr/법령/지방세법/제150조의2" target="_blank" rel="noopener noreferrer">법 §150의2 제2항</a></li>
        <li><strong>영업장 중과 제외</strong> — 본점 또는 주사무소에 영업장소가 함께 설치되는 경우 백화점 매장이나 은행 영업장 등 영업장소 및 부대시설 부분은 취득세 중과세 대상에서 제외된다는 원칙.</li>
        <li>관련 조문: <a href="https://law.go.kr/법령/지방세법/제112조" target="_blank" rel="noopener noreferrer">법 §112 제3항</a>, <a href="https://law.go.kr/법령/지방세법시행령/제84조의2" target="_blank" rel="noopener noreferrer">시행령 §84의2 제3항</a></li>
      </ul>
      ...
      <ul className="list-disc pl-6 my-4 space-y-1">
        ...
        <li><code className="bg-gray-100 px-1 rounded text-sm">지방세법 제138조 제1항</code></li>
      </ul>
      ...
      <p>지점 또는 분사무소의 의미.3 (입법목적에 배치되는 경우)</p>

      <p>```text</p>
      <p>대법원2008두18496 / 2011.6.10.선고 | 구 지방세법 제138조 제1항 제3호의 등록세 중과 요건인 ‘대도시 내 지점 또는 분사무소 설치에 따른 부동산등기’에서 ‘지점 또는 분사무소’의 의미와 그 인적 조직의 고용형식이 반드시 당해 법인에 직속하는 형태를 취해야 하는지 여부(소극) 및 등록세 중과 요건 사실이 충족된 경우 입법 목적에 배치되는지에 따라 적용을 달리할 수 있는지 여부 (2005두13162 판결 등)</p>
      <p>구 지방세법(2005. 12. 31. 법률 제7843호로 개정되기 전의 것) 제138조 제1항 제3호, 구 지방세법 시행령(2008. 2. 29. 대통령령 제20708호로 개정되기 전의 것) 제102조 제2항 및 구 지방세법 시행규칙(2008. 3. 24. 행정안전부령 제10호로 개정되기 전의 것) 제55조의2의 규정에 의하면, 등록세 중과 요건인 ‘대도시 내 지점 또는 분사무소 설치에 따른 부동산등기’에서 ‘지점 또는 분사무소’는 법인세법·부가가치세법 또는 소득세법의 규정에 의하여 등록된 사업장으로서 그 명칭 여하를 불문하고 인적·물적 설비를 갖추고 계속하여 당해 법인의 사무 또는 사업이 행하여지는 장소를 말하는데, / 여기서 말하는 인적 설비는 당해 법인의 지휘·감독하에 인원이 상주하는 것을 뜻할 뿐이고 고용형식이 반드시 당해 법인에 직속하는 형태를 취할 것을 요구하는 것은 아니다. 그리고 위 각 규정은 대도시 내 인구유입에 따른 인구팽창을 막고 대도시의 인구 분산을 기하는 데 목적이 있는 것이나, 일단 위 각 규정에 정한 요건사실이 충족되면 일률적으로 규정을 적용하여야 하는 것이 원칙이고, 구체적인 사안에서 입법 목적과의 배치 여부를 따져 적용 여부를 결정할 수는 없다</p>
      <p>```</p>



      <p>과밀억제권역 안에서 본점 신증축 후, 본점이 이전해 오면 구 취득세 중과대상임.</p>

      <p>```text</p>
      <p>대법원2012두6551 / 2012.7.12.선고 | 과밀억제권역 안에서 본점 또는 주사무소용 건축물을 신축 또는 증축하여 취득하는 경우, 동일한 과밀억제권역 안에 있던 기존의 본점 또는 주사무소에서 이전해 오더라도 구 취득세 중과대상이다.</p>
      <p>구 지방세법(2010. 3. 31. 법률 제10221호로 전부 개정되기 전의 것, 이하 같다) 제112조 제3항은 1998. 12. 31. 법률 제5615호로 개정되기 전과 달리 입법 취지를 반영하여 과밀억제권역 안에서 본점 또는 주사무소의 사업용 부동산을 취득하는 경우 중 인구유입과 산업집중의 효과가 뚜렷한 신축 또는 증축에 의한 취득만을 적용대상으로 규정하고 입법 취지에 어울리지 않는 그 밖의 승계취득 등은 미리 적용대상에서 배제하였으므로, / 조세법률주의 원칙상 위 규정은 특별한 사정이 없는 한 법문대로 해석하여야 하고 더 이상 함부로 축소해석하여서는 아니되는 점, 과밀억제권역 안에서 신축 또는 증축한 사업용 부동산으로 본점 또는 주사무소를 이전하면 동일한 과밀억제권역 안의 기존 사업용 부동산에서 이전해 오는 경우라 하더라도 전체적으로 보아 그 과밀억제권역 안으로의 인구유입이나 산업집중의 효과가 없다고 할 수 없는 점 등을 종합하면, / 과밀억제권역 안에서 본점 또는 주사무소용 건축물을 신축 또는 증축하여 취득하면 동일한 과밀억제권역 안에 있던 기존의 본점 또는 주사무소에서 이전해 오는 경우라고 하더라도 구 지방세법 제112조 제3항에 의한 취득세 중과대상에 해당한다고 봄이 타당하다.</p>
      <p>```</p>



      <p>취득부동산이 본점.지점 모두 관계될 경우 등록세 중과사례</p>

      <p>일산지점 설립2년, 본점설립8년 : 지점과 관계된 부동산만 등록세 중과</p>

      <p>```text</p>
      <p>대법원2003두7620 / 2006.4.27.선고 | [1] 구 지방세법 시행령 제102조 제2항에 정한 등록세 중과대상이 되는 ‘일체의 부동산등기’의 의미 및 여기에 다른 지점 등과 관계되어 취득한 부동산의 등기까지 포함되는지 여부(소극) / [2] 구 지방세법 제138조 제1항 제3호 후단의 ‘법인 또는 지점 등의 설립·설치·전입 이후의 부동산등기’에 관한 적용세율의 기준 규정</p>
      ...
      <p>```text</p>
      <p>대법원2012두13511 / 2015.3.26 | 대도시에서 법인 설립, 지점·분사무소 설치 및 법인의 본점·주사무소·지점·분사무소의 대도시 전입에 따라 부동산을 취득하는 경우와 그 설립·설치·전입 이후 5년 이내에 대도시 내에서 부동산을 취득하는 경우, 취득세 중과대상이 되는 요건</p>
      <p>구 지방세법(2013. 12. 26. 법률 제12118호로 개정되기 전의 것) 제13조 제2항 제1호, 구 지방세법 시행령(2013. 3. 23. 대통령령 제24425호로 개정되기 전의 것) 제27조 제3항에 의하면, 대도시에서 법인 설립, 지점·분사무소 설치 및 법인의 본점·주사무소·지점·분사무소의 대도시 전입에 따라 부동산을 취득하는 경우와 설립·설치·전입 이후 5년 이내에 대도시 내에서 부동산을 취득하는 경우를 구분하여, / 전자의 경우에는 법인의 본점·주사무소·지점 또는 분사무소의 용도로 직접 사용할 목적으로                    부동산을 취득하는 경우에 한하여 취득세 중과대상이 되고, / 후자의 경우에는 법인 또는 사무소 등이 설립·설치·전입 이후 5년 이내에 부동산을 취득하였다는                   요건만 갖추면 용도를 불문하고 취득세 중과대상이 된다</p>
      <p>```</p>



      <p>취득한 부동산으로 이전하여 다른업종을 새로이 시작한 것은 해당업종을 위한 지점을 설치한 것임</p>

      <p>```text</p>
      <p>대법원2008두17080 / 2008.12.11.선고 | 이미 지점이 설치되어 있었다 하더라도 새로운 부동산으로 이전하여 다른 업종을 새로이 시작한 것은 사실상 해당업종을 위한 지점을 설치한것에 해당한다.중과</p>
