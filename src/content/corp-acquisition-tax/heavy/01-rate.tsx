  ...
  return (
    <div className="space-y-6">
      ...
      <CalcBox title="■ 원문" id="source">
        <SubSection title="● 법인 중과세율">
        </SubSection>

        <SubSection title="● 【제1항 - 구 취득세 중과】 - 본점 신증축">
          <table>
          <thead>
        ...
        <SubSection title="● 【제2항 - 구 등록세 중과】 - 대도시 법인 설립후 5년이내 부동산취득">
          <table>
          <thead>
        ...
        <SubSection title="● 【제1항(구취득세) 제2항(구등록세) 동시 중과)】 대도시 설립후 5년이내 법인의 본점 신축">
          <p>```text</p>
          <p>구분 | 세 율 | 비고</p>
          <p>전체 | 취득세 | 교육세 | 농특세</p>
        ...
        <SubSection title="● 【13조의2 – 주택 매매 및 증여 취득시 중과】 - 2020.8.12.이후 취득분부터">
          <table>
          <thead>
