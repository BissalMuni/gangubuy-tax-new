  ...
  return (
    <div className="space-y-6">
      ...
      <CalcBox title="■ 수록 판례 (1건)" id="section-3">
        <SubSection title="● 대법원2016두34783">
      ...
      <CalcBox title="■ 조심 판례 (1건)" id="section-4">
        <SubSection title="● 조심2013지0616">
      ...
      <CalcBox title="■ 경매 취득일" id="section-7">
        <p>```text</p>
