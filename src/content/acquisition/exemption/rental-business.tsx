  ...
  return (
    <div className="space-y-6">
      ...
      <blockquote className="border-l-4 border-gray-300 pl-4 my-4 text-gray-600 italic">
        <p>임대사업자 취득세·재산세 감면 요건, 감면율, 추징 요건 및 처리방법 안내.</p>
      </blockquote>
      ...
      <h3 className="text-lg font-semibold mt-6 mb-3">B. 재산세 추징</h3>

      <ul className="list-disc pl-6 my-4 space-y-1">
        <li>감면사유 소멸일부터 <strong>소급하여 5년 이내</strong> 감면분 추징</li>
        <li>단기: 2019년(신설시)부터 추징</li>
        <li>장기: 5년치 추징</li>
      </ul>
