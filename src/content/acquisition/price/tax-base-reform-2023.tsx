...
export default function TaxBaseReform2023V10() {
  return (
    <div className="space-y-6">
      ...
      <CalcBox title="■ 주요 개정 내용 비교" id="1.-주요-개정-내용-비교">
      ...
      <CalcBox title="■ 시가인정액 평가기간 및 적용순서" id="2.-시가인정액-평가기간-및-적용순서">
        <SubSection title="● 평가기간 내 판단기준일">
      ...
      <CalcBox title="■ 유사부동산의 범위" id="3.-유사부동산의-범위">
        <SubSection title="● 공동주택가격이 있는 공동주택">
        ...
        <SubSection title="● 공동주택가격이 없는 경우">
      ...
      <CalcBox title="■ 무상취득 과세표준 적용요령 ('23 운영요령)" id="4.-무상취득-과세표준-적용요령-('23-운영요령)">
        <SubSection title="● 신고전 납세자 안내">
          <ul className="list-disc pl-6 my-4 space-y-1">
      ...
      <CalcBox title="■ 가산세 적용" id="5.-가산세-적용">
        <table style={{width: '100%', borderCollapse: 'collapse', fontSize: 'var(--content-font-size, 13px)', marginBottom: '16px'}}>
        <thead>
        <tr style={{backgroundColor: '#f0f0f0'}}>
