...
export default function VesselAcquisitionV10() {
  return (
    <div className="space-y-6">
      ...
      <CalcBox title="■ 1. 신고 절차" id="1.-신고-절차">
        <Insight>
      ...
      <CalcBox title="■ 2. 구비서류" id="2.-구비서류">
      ...
      <CalcBox title="■ 3. 취득세와 재산세의 납세지 차이점" id="3.-취득세와-재산세의-납세지-차이점">
        <table style={{width: '100%', borderCollapse: 'collapse', fontSize: 'var(--content-font-size, 13px)', marginBottom: '16px'}}>
        <thead>
        <tr style={{backgroundColor: '#f0f0f0'}}>
      ...
      <CalcBox title="■ 4. 신고 화면 처리" id="4.-신고-화면-처리">
        <Insight>
