...
export default function NonRealestateV10() {
  return (
    <div className="space-y-6">
      ...
      <CalcBox title="■ 1. 적용 대상" id="1.-적용-대상">
      ...
      <CalcBox title="■ 2. 주요 내용" id="2.-주요-내용">
        <SubSection title="● 가. 차량">
          <ul className="list-disc pl-6 my-4 space-y-1">
      ...
      <CalcBox title="■ 3. 세율·금액" id="3.-세율·금액">
        <p>| 구분 | 세율 | 과세표준 | 비고 |</p>
        <p>|------|------|----------|------|</p>
      ...
      <CalcBox title="■ 4. 관련 법령" id="4.-관련-법령">
        <p>| 구분 | 법령명 | 조항 | 비고 |</p>
        <p>|------|--------|------|------|</p>
      ...
      <CalcBox title="■ 5. 주의사항" id="5.-주의사항">
        <Insight>
          <ul className="list-disc pl-6 my-4 space-y-1">
