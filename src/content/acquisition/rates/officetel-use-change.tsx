...
export default function OfficetelUseChangeV10() {
  return (
    <div className="space-y-6">
      ...
      <CalcBox title="■ 필요서류" id="필요서류">
        <SubSection title="● 주거용 변경 신청시">
        ...
        <SubSection title="● 사무실 확인시 (사무용 변경)">
      ...
      <CalcBox title="■ 시스템 처리" id="시스템처리">
        <SubSection title="● 건물용도코드 변경">
          <table style={{width: '100%', borderCollapse: 'collapse', fontSize: 'var(--content-font-size, 13px)', marginBottom: '16px'}}>
          <thead>
          <tr style={{backgroundColor: '#f0f0f0'}}>
          <th style={{border: '1px solid #d9d9d9', padding: '8px', fontWeight: 'bold'}}>구분</th>
